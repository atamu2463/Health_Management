...
export function ErrorScreen({ code, title, description, icon, action }: ErrorScreenProps) {
  return (
    <div className="min-h-svh bg-background">
      ...
      <div className="flex w-full max-w-md flex-col items-center gap-6 text-center">
        ...
        <div className="flex flex-col gap-2">
          <p className="text-5xl font-bold tracking-tight text-primary sm:text-6xl">{code}</p>
          <h1 className="text-xl font-bold text-foreground text-balance sm:text-2xl">{title}</h1>
